...
const deployments = require('../deployments/matic_rinkeby.json')
async function main () {
    ...
    const Tenderizer: Tenderizer = (await hre.ethers.getContractAt('Tenderizer', deployments.contracts.Matic.address)) as Tenderizer
