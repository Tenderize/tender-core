...
import "../libs/PreciseMathUtils.sol";
    ...
    */
    ...
    function getSharesByPooledTokens(uint256 _TokensAmount) public view returns (uint256) {
        ...
        if (_totalPooledTokens == 0) {
            ...
            return PreciseMathUtils.percOf(_TokensAmount, _totalShares, _totalPooledTokens);
        }
    }
    ...
    function getPooledTokensByShares(uint256 _sharesAmount) public view returns (uint256) {
        ...
        if (currShares == 0) {
            ...
            return PreciseMathUtils.percOf(_sharesAmount, _getTotalPooledTokens(), currShares);
        }
    }
