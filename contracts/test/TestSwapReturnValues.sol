...
contract TestSwapReturnValues {
    ...
    function test_swap(
        ...
        uint256 balanceBefore = tokenTo.balanceOf(
            address(this)
        );
        ...
        uint256 balanceAfter = tokenTo.balanceOf(
            address(this)
        );
    ...
    function test_addLiquidity(uint256[2] calldata amounts, uint256 minToMint)
        public
    {
    ...
    function test_removeLiquidity(uint256 amount, uint256[2] memory minAmounts)
        public
    {
    ...
    function test_removeLiquidityOneToken(
        ...
        uint256 balanceBefore = tokenReceive.balanceOf(
            address(this)
        );
        ...
        uint256 balanceAfter = tokenReceive.balanceOf(
            address(this)
        );
